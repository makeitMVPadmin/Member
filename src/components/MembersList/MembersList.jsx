        ...
        <>
            ...
            <div className="body-copy">
                <ul className="member-list__header">
                    <li className="column--short body-copy">
                        <input className="member-list__input" type="checkbox" onChange={handleSelectAll} />
                    </li>
                ...
                {users.map((user, index) => (
                    <div className="member-card__background" key={user.id}>
                        <ul className="member-card body-copy">
                            <li className="member-card__checkbox column--short">
                                <input
